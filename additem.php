...
<body>
    ...
    <h1>Item Details</h1>
        <div class="form">
            <form action="error.php" method="post" enctype="multipart/form-data" class="formContent" style="display:flex;flex-direction:row;width:100%;gap:24px;">
                <div class="formL">
                    <p>Image</p>
                ...
                <div class="formR">
                    <div class="input">
                        ...
                        <input type="text" name="brand" id="brand" placeholder="Enter item brand" required>
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        ...
                        <input type="text" name="color" id="color" placeholder="Enter item color" required>
                    </div>
                    <div class="input">
                    ...
                    <button type="submit" name="submit" value="save">Add Item</button>
                </div>
            </form>
        </div>
    </div>
